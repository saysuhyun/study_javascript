...
console.log(yuJin2.dance()); // undefined 가 춤을 춘다  함수의 this는 글로벌에 매핑됨
...
console.log(returnName()); // 글로벌 매핑이라 undefined 

const yuJin3 = {
    name: '안유진',
}

console.log(returnName.call(yuJin3)); //this를 yujin3에 매핑 시킴  //안유진
console.log(returnName.apply(yuJin3)); // 안유진 

/**
 * 1) call -> 컴마를 기반으로 아규먼트를 순서대로 넘겨주고
 * 2) apply ->  아규먼트를 리스트로 입력해야한다.
 * 기능은 같고 그냥 아규먼트 받는게 다른가보네
 */
